...
and execute =hpge_simulation= module]]).
...
|-----------------------+------------------------------------------------------|
| hpge_analysis         | @hpge_simulation_dir:install/lib/libhpge_analysis.so |
...
#+BEGIN_SRC sh
  [name="hpge_simulation" type="mctools::g4::simulation_module"]
...
#+BEGIN_SRC sh
  [name="hpge_basic_analysis_module" type="hpge::basic_analysis_module"]
...
#+BEGIN_SRC sh
  [name="hpge_analysis_chain" type="dpp::chain_module"]
...
#+BEGIN_SRC sh
  bxdpp_processing                                                     \
      ...
      --module hpge_analysis_chain                                     \
      --datatools::resource-path="hpge_simulation_dir@$PWD"            \
      --load-dll hpge_simulation                                       \
      --load-dll Bayeux_mctools_geant4                                 \
      --max-records 100                                                \
      --output-file /tmp/${USER}/hpge.d/io_ouput_hpge_simulation.brio
#+END_SRC
...
#+BEGIN_SRC sh
  flvisualize                                                           \
      ...
      --style-config-file $PWD/config/visualization/hpge_simulation.sty \
      --input-file /tmp/${USER}/hpge.d/io_ouput_hpge_simulation.brio
#+END_SRC
* Footnotes
